      ...
      <section className="section section--paper privacy-content" aria-labelledby="privacy-title">
        <div className="container privacy-grid">
          ...
          <div className="privacy-sections">
            ...
            <section><h2>Deletion requests</h2><p>Use the same contact channel through which you submitted your inquiry and ask for deletion. A dedicated privacy email will be published before direct web-form delivery is enabled.</p></section>
          </div>
        </div>
      </section>
    </main>
